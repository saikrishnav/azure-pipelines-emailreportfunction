...
namespace EmailReportFunction.Wrappers
{
    public class ReportFactory : IReportFactory
    {
        ...
        public IDataProvider GetDataProvider(string jsonRequest, ILogger logger)
        {
            ...
            if (pipelineConfiguration is ReleaseConfiguration)
            {
                ...
                return new ReleaseDataProvider(releaseConfig, this.GetReleaseHttpClient(releaseConfig, logger), logger);
            }
            return null;
        }
